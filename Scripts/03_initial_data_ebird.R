...
#'     - I made 3 special requests: Eastern Bluebird, Western Bluebird, Mountain Bluebird
...
#'   - You'll have to move the 4 main files into the same folder after they've been extracted
#'     (e.g., ebd_sampling_relOct-2019.txt and each species file, like ebd_easblu_relOct-2019.txt)
